...
local DARK_RED = Color3.fromRGB(80, 10, 10)
...
-- ========== CONFIG ==========
local ConfigFileName = "EDO_AUTOPLAY_CONFIG.json"
...
Instance.new("UIStroke", panel).Color = ORANGE
...
discordSub.Text = "discord.gg/boxrot"
discordSub.TextColor3 = Color3.fromRGB(255, 180, 100)
...
lockBtn.BackgroundColor3 = DARK_RED
lockBtn.Text = "🔓"
...
lockBtn.MouseButton1Click:Connect(function()
    ...
    lockBtn.BackgroundColor3 = isLocked and ORANGE or DARK_RED
end)
...
local function makeSpeedRow(y, label, key)
    ...
    box.BackgroundColor3 = DARK_RED
    box.Text = tostring(Values[key])
    box.TextColor3 = ORANGE
...
leftBtn.BackgroundColor3 = DARK_RED
leftBtn.Text = "LEFT: OFF"
leftBtn.TextColor3 = ORANGE
...
rightBtn.BackgroundColor3 = DARK_RED
rightBtn.Text = "RIGHT: OFF"
rightBtn.TextColor3 = ORANGE
rightBtn.Font = Enum.Font.GothamBold
rightBtn.TextSize = 10
Instance.new("UICorner", rightBtn).CornerRadius = UDim.new(0, 4)

updateButtonUI = function()
    leftBtn.BackgroundColor3 = Enabled.AutoLeft and ORANGE or DARK_RED
    leftBtn.Text = Enabled.AutoLeft and "LEFT: ON" or "LEFT: OFF"
    rightBtn.BackgroundColor3 = Enabled.AutoRight and ORANGE or DARK_RED
